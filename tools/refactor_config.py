...
# 4. 替换筛选选项
# 紧急程度选项 -> 风险等级
html = html.replace('<option value="极高">极高</option>', '<option value="第三类">第三类</option>')
html = html.replace('<option value="高">高</option>', '<option value="第三类">第三类</option>')
html = html.replace('<option value="中">中</option>', '<option value="第二类">第二类</option>')
html = html.replace('<option value="低">低</option>', '<option value="第一类">第一类</option>')
