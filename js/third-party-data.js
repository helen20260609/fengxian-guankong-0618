...
function createDefaultData() {
    ...
    const experts = [
        ...
        { expertId: 'EXP-009', name: '杨秀英', gender: '女', birth: '1972-03-15', orgId: '', orgName: '', domain: '城镇自建房', direction: '结构检测', title: '教授级高工', titleOrg: '中国土木工程学会', titleTime: '2010-08', years: '28', phone: '13800138009', email: 'yangxy@example.com', address: '上海市浦东新区', workplace: '上海市', status: '正常', expertType: '独立专家' },
        { expertId: 'EXP-010', name: '黄志强', gender: '男', birth: '1968-07-21', orgId: '', orgName: '', domain: '基坑', direction: '地基处理', title: '高级工程师', titleOrg: '中国岩石力学与工程学会', titleTime: '2008-05', years: '32', phone: '13800138010', email: 'huangzq@example.com', address: '上海市徐汇区', workplace: '上海市', status: '正常', expertType: '独立专家' },
        { expertId: 'EXP-011', name: '周涛', gender: '男', birth: '1975-11-30', orgId: '', orgName: '', domain: '交通', direction: '道路桥梁', title: '注册结构师', titleOrg: '住建部执业资格注册中心', titleTime: '2012-09', years: '24', phone: '13800138011', email: 'zhout@example.com', address: '上海市黄浦区', workplace: '上海市', status: '正常', expertType: '独立专家' },
        { expertId: 'EXP-012', name: '吴刚', gender: '男', birth: '1980-01-18', orgId: '', orgName: '', domain: '建筑工地', direction: '电气安全', title: '注册岩土工程师', titleOrg: '中国电机工程学会', titleTime: '2015-11', years: '18', phone: '13800138012', email: 'wug@example.com', address: '上海市静安区', workplace: '上海市', status: '正常', expertType: '独立专家' }
    ];
